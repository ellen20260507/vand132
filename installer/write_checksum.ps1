...
[void]$sb.AppendLine('ESD-1000 release checksum (vand1 3-2)')
...
[void]$sb.AppendLine('Prefer sending ESD-1000_Portable.zip via WeChat instead of setup.exe.')
[void]$sb.AppendLine('')

foreach ($name in @('ESD-1000_Setup.exe', 'ESD-1000_Portable.zip')) {
